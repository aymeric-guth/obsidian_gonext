...
var MyPlugin = class extends import_obsidian.Plugin {
  ...
  grugAlias(_id) {
    ...
    if (cache.frontmatter.alias !== void 0 && cache.frontmatter.alias.length > 0) {
