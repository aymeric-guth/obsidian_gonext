    ...
    this.app.workspace.on("active-leaf-change", () => {
      ...
      for (const leaf of root.children) {
        ...
        if (fm.type === 3 && Helper.getProject(fm) !== void 0 && Helper.getProject(fm) === "project/daily") {
          ...
          text = `\u{1F4C5} ${dayShort[at.getDay()]}. ${at.getDay()} ${monthShort[at.getMonth()]}`;
        } else if (fm.type === 2) {
          ...
          text = `\u{1F4D3} ${dayShort[at.getDay()]}. ${at.getDay()} ${monthShort[at.getMonth()]}`;
        } else {
          continue;
        }
