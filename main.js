    ...
    this.addCommand({
      ...
      callback: () => {
        navigator.clipboard.readText().then((text) => {
          ...
          const file = this.getFileFromUUID(_id);
          Assert.True(file !== void 0, `getFileFromUUID: returned undefined for uuid: ${_id}`);
